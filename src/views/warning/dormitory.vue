  ...
  <div class="dashboard-editor-container">
    ...
    <el-row style="background:#fff;padding:16px 16px 16px;margin-bottom:32px;">
      ...
      <el-table :data="tableData" border style="width: 100%" @cell-click="personMessage">
        ...
        <el-table-column prop="zhsj" label="最后一次出现时间" />
...
export default {
  ...
  methods: {
    ...
    getInitialData() {
      var vm = this
      axios.get('http://localhost:8080/dormitoryWarning/getData').then(function(response) {
    ...
    removeHandle(formName) {
      ...
      this.$confirm('确认解除预警吗, 是否继续?', '提示', {
        ...
        this.feedBackRecords.type = 'dormitory'
